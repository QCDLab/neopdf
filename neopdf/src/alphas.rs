...
mod tests {
    use super::*;
    use crate::metadata::{InterpolatorType, MetaData, SetType};
    ...
    fn test_lambda_qcd() {
        ...
        assert_eq!(analytic.lambda_qcd(6).unwrap(), 0.213);
    ...
    fn test_alphas_q2_analytic_values() {
        ...
        let as_q2_high = analytic.alphas_q2(1000.0);
        assert!(as_q2_high < as_q2);
    }
}
